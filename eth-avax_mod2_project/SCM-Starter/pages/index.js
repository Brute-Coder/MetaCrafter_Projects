...
export default function HomePage() {
  ...
  const initUser = () => {
    ...
    return (
      <div>
        ...
        <p>you can transact 5 or 10 Token with one click or give a custom amount below</p>
        <button onClick={deposit5}>Deposit 5 Token</button>
        <button onClick={withdraw5}>Withdraw 5 Token</button>
        <br/>
        <button onClick={deposit10}>Deposit 10 Token</button>
        <button onClick={withdraw10}>Withdraw 10 Token</button>
        <br/>
        <form>
  ...
  return (
    <main className="container">
      <header><h1>Welcome to the GO ATM!</h1></header>
      <hr></hr>
      <h3> Here you can dirctly diposit or withdraw token in your metamask wallet </h3>
      <hr></hr>
